//
//  CVLayerViewRip.swift
//  ChatRobot
//
//  Created by Jacky Fang on 2019/1/14.
//  Copyright © 2019 Jacky Fang. All rights reserved.
//

import UIKit

class CVLayerViewRip: UIView {
    ...
    override init(frame: CGRect) {
        ...
        // 脉冲效果的颜色  (注释*1)
        pulseLayer.fillColor = #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1).cgColor
    ...
    func starAnimation() {
        ...
        scaleAnimation.fromValue = NSValue(caTransform3D: CATransform3DScale(t, 0.4, 0.4, 0.0))
